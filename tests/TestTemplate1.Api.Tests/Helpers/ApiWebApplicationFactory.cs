        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate1DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate1DbContext>();
        ...
        public TestTemplate1DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate1DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate1DbContext>()
            ...
            public TestTemplate1DbContext BuildContext() =>
                new(_options);
        }
    }
}
