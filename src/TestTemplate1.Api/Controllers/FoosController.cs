...
using TestTemplate1.Application.Questions.Commands;
using TestTemplate1.Application.Questions.Queries;

namespace TestTemplate1.Api.Controllers
{
    [ApiController]
    ...
    public class FoosController : ControllerBase
    {
        ...
        {
            _logger.LogInformation("logging foofoofoofoo11111111");
