...
using TestTemplate1.Api.Helpers;
using TestTemplate1.Api.Middlewares;
using TestTemplate1.Application;
using TestTemplate1.Common.MessageBroker;
using TestTemplate1.Core;
...
namespace TestTemplate1.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestTemplate1DbContext>(options =>
            {
                var connString = new SqlConnectionStringBuilder(_configuration.GetConnectionString("TestTemplate1DbConnection") ?? string.Empty)
                {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc(
                    "TestTemplate1OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate1 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate1.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate1.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate1Client", builder =>
            {
            ...
            {
                x.UsingInMemory();
                x.AddEntityFrameworkOutbox<TestTemplate1DbContext>(o =>
                {
            ...
            services.AddTestTemplate1ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate1DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate1Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate1OpenAPISpecification/swagger.json", "TestTemplate1 API");
