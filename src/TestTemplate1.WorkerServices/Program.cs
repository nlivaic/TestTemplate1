...
using TestTemplate1.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate1.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate1.Core;
using TestTemplate1.Core.Events;
using TestTemplate1.Data;
using TestTemplate1.WorkerServices.FaultService;
using TestTemplate1.WorkerServices.FooService;
using LoggerExtensions = SparkRoseDigital.Infrastructure.Logging.LoggerExtensions;

namespace TestTemplate1.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate1 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate1 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration.GetConnectionString("TestTemplate1DbConnection"))
                        {
